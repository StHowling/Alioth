...
if __name__ == '__main__':
    ...
    with open(EVENT_FILENAME, "r") as eventsFile:
        for line in eventsFile.readlines():
            ...
            total_event_dict[linestrip[0]] = linestrip[1]

    total_events_name_list = list(total_event_dict.values())
    total_events_list = list(total_event_dict.keys())
    ...
    csv_headers = total_events_name_list[:]
    ...
    with open(CSV_FILENAME, 'a') as csvFile:
        ...
        try:
            while True:
                ...
                csv_event_value[total_event_dict[event_name]] = event_value
